...
//        idCategory[0] = 1;
        ...
        spCategory.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                categoryCurrent = i+1;
                System.out.println(categoryCurrent);
            }
        ...
        System.out.println(spCategory.getSelectedItemPosition() +1 +"------");
        RequestBody category_id = RequestBody.create(MediaType.parse("multipart/form-data"), String.valueOf( spCategory.getSelectedItemPosition() +1));
