    ...
    private void setEvent() {
        exportPDF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PdfExporter.exportProductsToPdf(getContext(),ProductList ,thang.getSelectedItem().toString()+nam.getSelectedItem().toString()+".pdf");
//                ExportPDF exportPDF = new ExportPDF();
//                exportPDF.main(getContext(), thang.getSelectedItem().toString(),  nam.getSelectedItem().toString(), "DINHNHONAM SHOP",ProductList );
    ...
    private  void LoadData() throws JSONException {
        ...
        UserAPI.ApiGet(getContext(), Utils.BASE_URL + "order/best-sell/"+thang.getSelectedItem().toString().substring(6)+"/"+nam.getSelectedItem(), new APICallBack() {
            ...
            public void onSuccess(JSONObject response) throws JSONException {
                ...
                slSanPham.setText(String.valueOf(jsonArray.length()));
            }
