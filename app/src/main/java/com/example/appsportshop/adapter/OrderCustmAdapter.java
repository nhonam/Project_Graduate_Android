...
public class OrderCustmAdapter extends ArrayAdapter<Order> {
    Context myContext;
    int myLayout;
    ...
    public OrderCustmAdapter(@NonNull Context context, int resource, @NonNull ArrayList<Order> listOrder) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        OrderCustmAdapter.ViewHolder viewHolder = null;
        if (convertView == null) {
            convertView = LayoutInflater.from(myContext).inflate(myLayout, null);
            viewHolder = new OrderCustmAdapter.ViewHolder(convertView);
            convertView.setTag(viewHolder);
        } else {
            viewHolder = (OrderCustmAdapter.ViewHolder) convertView.getTag();
        }
